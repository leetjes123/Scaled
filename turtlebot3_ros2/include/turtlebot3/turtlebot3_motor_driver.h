...
public:
  ...
  bool read_present_position(int32_t &left_value, int32_t &right_value, int32_t &frontright_value, int32_t &frontleft_value);
  ...
  bool read_profile_acceleration(uint32_t &left_value, uint32_t &right_value, uint32_t &frontright_value, uint32_t &frontleft_value);

  bool write_position(int32_t left_angle, int32_t right_angle);
  bool write_velocity(int32_t left_value, int32_t right_value);
  bool write_profile_acceleration(uint32_t left_value, uint32_t right_value, uint32_t frontright_value, uint32_t frontleft_value);
...
private:
  ...
  uint8_t frontleft_wheel_id_;
  uint8_t frontright_wheel_id_;
  bool torque_;
};
